...
public class routes {
  ...
  public static final controllers.ReverseDeveloperController DeveloperController = new controllers.ReverseDeveloperController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseDeveloperController DeveloperController = new controllers.javascript.ReverseDeveloperController(RoutesPrefix.byNamePrefix());
